...
class Test_API_Utils:
    ...
    def login(self, playwright:Playwright, userCred, baseURL):
    ...
    def createOrder(self, playwright:Playwright, userCred, baseURL):
        BaseURL = baseURL
        self.login(playwright, userCred, baseURL)
